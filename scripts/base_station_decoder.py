...
class JointStateDecoder(Node):
    ...
    def listener_callback(self, msg):
        joint_data = json.loads(msg.data)  # Deserialize the JSON string
        ...
        joint_state_msg.name = ['robot1_' + name for name in joint_data["names"]]
...
def main(args=None):
    ...
    color_start = "\033[35m"
    color_reset = "\033[0m"
    decoder.get_logger().info(f"{color_start}Decoding '/robot1/raw_strings_joint_states to /robot1/joint_states{color_reset}")
