...
class JointStateStringifier(Node):
    def __init__(self):
        ...
        self.publisher = self.create_publisher(
            String,
            '/robot1/raw_strings_joint_states',
            10)
    ...
    def listener_callback(self, msg):
        ...
        self.get_logger().info('Publishing: "%s"' % str_msg.data)
...
def main(args=None):
    ...
    color_start = "\033[35m"
    color_reset = "\033[0m"
    joint_state_stringifier.get_logger().info(f"{color_start}Encoding /joint_states to /robot1/raw_strings_joint_states{color_reset}")
